...
class Toturial extends React.Component {
  ...
  changeToturial(bottunName) {
    console.log(this.state.toturialClasses[this.state.toturialNumber]);
    if (bottunName === "next") {
    ...
    return (
      <div id="tutorial" className="mainContainer">
        ...
        <div className="section" id="third-toturial">
          ...
          <h6 className="paragraph">
            or move the start / end node by handle clicking and draging the node
            even after the algorithm has finished running.
          </h6>
        </div>
